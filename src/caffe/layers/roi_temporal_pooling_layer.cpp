...
#include "caffe/layers/roi_temporal_pooling_layer.hpp"
...
void ROITemporalPoolingLayer<Dtype>::LayerSetUp(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top) {
  ROITemporalPoolingParameter roi_pool_param = this->layer_param_.roi_temporal_pooling_param();
...
template <typename Dtype>
void ROITemporalPoolingLayer<Dtype>::Reshape(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top) {
...
template <typename Dtype>
void ROITemporalPoolingLayer<Dtype>::Forward_cpu(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top) {
...
template <typename Dtype>
void ROITemporalPoolingLayer<Dtype>::Backward_cpu(const vector<Blob<Dtype>*>& top,
...
#ifdef CPU_ONLY
STUB_GPU(ROITemporalPoolingLayer);
#endif

INSTANTIATE_CLASS(ROITemporalPoolingLayer);
REGISTER_LAYER_CLASS(ROITemporalPooling);
